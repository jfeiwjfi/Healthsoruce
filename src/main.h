...
public:
    ...
    {
        // Healthsource: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Healthsource: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Healthsource: two types of block: proof-of-work or proof-of-stake
    ...
    // Healthsource: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Healthsource: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Healthsource: block index flags
    enum  
    {
