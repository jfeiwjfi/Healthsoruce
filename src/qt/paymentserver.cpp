...
const QString BITCOIN_IPC_PREFIX("Healthsource:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Healthsource: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Healthsource: click-to-pay handler");
    else
...
{
    // clicking on Healthsource: URLs creates FileOpen events on the Mac:
